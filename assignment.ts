...
let num:number= 12;
let message2:string=`MY favourite number is ${num}`;
...
let cars: string[] = ["Tesla Model 3", "Honda Civic", "Ford Mustang", "BMW M3"];
...
const guestList: string[] = ["Hamzah", "Okasha", "Bilal","Arsalan"];
...
let placesToVisit: string[] = ["karachi", "Lahore", "islamabad", "Abotabad", "Kashmir"];
...
let favoritecars: string[] = ["Tesla Model S", "Porsche 911", "Ford Mustang", "Toyota Supra", "BMW M3"];
...
function ageCriteria(personAge:number){
    if(personAge< 2){
...
let usernames: string[] = ['admin', 'Tasleem', 'hamzah', 'jamal', 'kashan'];
...
const currentUsers: string[] = ['Tasleem', 'shehriyar', 'Faraz', 'Subhan', 'Ahtisham'];

// Make another list of new users
const newUsers: string[] = ['Ahtisham', 'Tasleem', 'Kashan', 'Daniyal', 'Faraz'];
...
function makeShirt2(size: string, message: string): void {
...
const magicianNames: string[] = ['Merlin', 'David Copperfield', 'Houdini', 'Luna'];
...
function createCar(manufacturer: string, model: string, ...otherInfo: any[]): object {
    const car: object = {
      manufacturer,
      model,
    };
